...
class HomeActivity : AppCompatActivity() {
    ...
    private fun showNewProjectDialog() {
        ...
        input.setText("Mon Ã©mission")

        input.selectAll()

        input.hint = "Nom de l'Ã©mission"
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            ...
            if (name.isNotEmpty()) {
                ...
                if (projDir.exists()) {
                    ...
                    Toast.makeText(this, "Ce nom existe dÃ©jÃ ", Toast.LENGTH_SHORT).show()
    ...
    private fun showDeleteDialog(dir: File) {
        ...
        AlertDialog.Builder(this)
            ...
            .setTitle("Supprimer l'Ã©mission ?")

            .setMessage("ATTENTION : L'Ã©mission '${dir.name}' et tous ses fichiers seront supprimÃ©s.")
            ...
            .setPositiveButton("Supprimer") { _, _ ->
                ...
                Toast.makeText(this, "Ã‰mission supprimÃ©e", Toast.LENGTH_SHORT).show()
    ...
    class ProjectAdapter(
        ...
        override fun onBindViewHolder(holder: VH, position: Int) {
            ...
            holder.txtDate.text = "ModifiÃ© : " + sdf.format(Date(dir.lastModified()))

...
class ProjectActivity : AppCompatActivity() {
    ...
    override fun onPause() {
        ...
        stopPreview() // ArrÃªter la lecture si on quitte l'Ã©cran
    ...
    private fun showNewChronicleDialog() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            ...
            if (chronicleList.any { it.name.equals(safeName, ignoreCase = true) }) {
                ...
                Toast.makeText(this, "Une chronique porte dÃ©jÃ  ce nom", Toast.LENGTH_SHORT).show()
    ...
    private fun importFileToProject(uri: Uri) {
        ...
        Thread {
            ...
            try {
                ...
                runOnUiThread { refreshList(); Toast.makeText(this, "ImportÃ©", Toast.LENGTH_SHORT).show() }
    ...
    // --- EXPORT AVEC PROGRESSION ---
       ...
       private fun performMerge() {
         ...
         // 1. Normaliser : SÃ©parer les accents des lettres (ex: "Ã©" devient "e" + "Â´")
         ...
         // 3. Remplacer les caractÃ¨res non-alphanumÃ©riques (espaces, ponctuation) par des underscores
         ...
         // RÃ©sultat : Nom_Normalise_20231215_1830.m4a
    ...
    fun onEditAudio(item: Chronicle) {
        ...
        stopPreview() // ArrÃªter la lecture avant d'ouvrir l'Ã©diteur
...
class ChronicleAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.txtStatus.text = "$scriptStatus â€¢ $audioStatus"
        ...
        if (hasAudio) {
            ...
            if (activity.isFilePlaying(item.audioFile)) {
                ...
                holder.btnRecord.setImageResource(R.drawable.ic_stop_read) // CarrÃ© Stop

...
class ScriptEditorActivity : AppCompatActivity() {
        ...
        if (uri != null) {
            ...
            try {
                ...
                contentResolver.openInputStream(uri)?.use { inputStream ->
                    ...
                    // Lire le contenu (en UTF-8 par d̩faut)

                    val text = inputStream.readBytes().toString(Charset.defaultCharset())

                    // On remplace le texte existant (ou inputScript.append(text) si tu pr̩f̬res)

                    inputScript.setText(text)

                    Toast.makeText(this, "Texte import̩", Toast.LENGTH_SHORT).show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            ...
            Toast.makeText(this, "Script sauvegard̩", Toast.LENGTH_SHORT).show()
